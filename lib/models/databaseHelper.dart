...
class DatabaseHelper {
  static final _databaseName = "medicalfiles.db";
  static final _databaseVersion = 1;

  static final table = 'medicalfile';

  static final columnId = '_id';
  static final columnfileNumber = 'filenumber';
  static final columndisease = 'disease';
  static final columnsensitivity = 'sensitivity';
  static final columnbloodType = 'bloodtype';
