    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            ...
            style: TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Questv'),
          ),
        ),
        body: Builder(
...
//     return Scaffold(
//       backgroundColor: Color(0xFF243953),
//       appBar: AppBar(title: Text('Add new Medical File')),
//       body: Padding(
...
//                 items: _propr.map((String dropDownStringItem) {
...
//                   onPressed: () {
//                     _insert(
//                         namecontroller.text, int.parse(weightcontrller.text));
//                   },
//                   color: Colors.blue,
//                   child: Text('_insert'),
//                 ),
